...
def detect_objects_owlv2(model_id, object_text, frame_end=20, camera_index=2):
    """
    ...
    Args:
        model_id: The model ID for OWL-ViT V2.
...
if __name__ == "__main__":
    try:
        ...
        centroid, confidence, processing_time = detect_objects_owlv2(model_id, "a black chisel.", 30, 0)
