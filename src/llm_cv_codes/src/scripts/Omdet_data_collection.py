...
def detect_objects_omdet(model_id, image_path):
    """
    ...
    with open(csv_file_path, mode='w', newline='') as file:
        ...
        for image_file in os.listdir(folder_path):
            if image_file.endswith(".jpg"):
                ...
                file_name, object_text, confidence, processing_time = detect_objects_omdet(model_id, image_path)
                try:
...
if __name__ == "__main__":
    try:
        ...
        csv_file_path = "Omdet_electrical_tools.csv"  # Path to the output CSV file
